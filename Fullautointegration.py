...
tiff_dir = os.path.join('D:',os.sep,'Integration_test','tiff_base') # location of directory containing tiff folders
...
# This section is to integrate all 2D images in folders matching the keyword, place 1D patterns in relevant directories
